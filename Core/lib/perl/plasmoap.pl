...
# <HEAD></HEAD>
# <body>
# We're sorry, the PlasmoAP tool is currently not available.
# </body>
# </HTML>
# EOHTML
# exit;
...
#require "/www/$server/cgi-bin/plasmodb/output_library.pl";

# require "plasmodb/output_library.pl";  
...
#my $tempdir="/www/$server/cgi-bin/blast_tmp/";
my $tempdir="$pwd/../tmp/blast_tmp/";
my $tempfile="tempfile.$id";
my $wwwpngdir="/blast_images/";
#my $pngoutdir="/www/$server/html/blast_images/";
my $pngoutdir="$pwd/../html/blast_images";
my $signalpbin="/files/cbil/software/signalp/current/signalp";
...
if ($PEPW){
  my $pepwlength=7;
  print STDERR "Build 'pepwindow' files ...\n" if $verbose;
  chdir  $tempdir;
...
sub include {
    #This sub is thought to include
    #a PlasmoDB like header
    my $fileToInclude=shift;
    open (FTI, "<$fileToInclude");
    my @include=<FTI>;
    close FTI;
    my $includeText=join ("", @include);
    return $includeText;
}
...
sub htmlhead {
    ...
    my $title = shift;
    my $server=lc($ENV{SERVER_NAME});
    my $text=&include("/www/$server/html/include/js-footer.html");
...
<head>
    ...
    <!-- base href="http://plasmodb.org/PlasmoDB.shtml" -->
    <link rel=stylesheet type="text/css" href="/include/js-format.css">
          <script language="JavaScript" TYPE="text/javascript" src="/images/showStat.js"></script>
          <script language="JavaScript" TYPE="text/javascript" src="/images/stdStat.js"></script>
  </head>
        ...
        <table WIDTH='640' align='center' cellpadding=2 cellspacing=0>
                    ...
                    <!-- PICTURES AND TITLE -->
        <tr>
        <td ALIGN=LEFT   width=41><img SRC="/images/ring.gif" BORDER=0 height=40 width=40></td>
        <td ALIGN=CENTER align=top colspan=8><b><font face="Arial,Helvetica" size=+3>&nbsp;PlasmoDB - $title &nbsp;</font></b></td>
        <td ALIGN=RIGHT  width=41><img SRC="/images/mero.gif" BORDER=0 height=40 width=40></td>
        </tr>
...
sub htmlend{
    my $server=lc($ENV{SERVER_NAME});
    my $text=&include("/www/$server/html/include/js-mailto.html");
    my $date=`date -I`;
    $date=~s/\s+$//;
    my $fulldate=`date`;
    $fulldate=~s/\s+$//;
          ...
          <table width=640 align='center'>
            <tr>
                          <td align='left' valign='middle'>
                                        ...
                                        <font face='Serif' color='#444488'><b><i>PlasmoDB</i></b></font> Version:&nbsp;4.0<br>
                                        <font face='Serif' color='#444488'><b><i>PlasmoDB</i></b></font> Date:&nbsp;$date
                </font>
        </td>
                          <td align='left' valign='middle'>
                                        <font face='sans-serif' size=-2>
                                        Plasmodium Sequence Release Date:2002/10/03<br>
                                        This page generated:&nbsp;$fulldate.
                                        </font>
                                </td>
                          <td align='left'>
                                  <table>
